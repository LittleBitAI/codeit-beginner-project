...
Korean, for the team: `README.md`, `contracts/README.md`, `docs/shared-files.md`. English, for you: this file (**how to work**, everywhere), `src/pipelines/<area>/CLAUDE.md` (**what you may do there**), `docs/testing.md`.
