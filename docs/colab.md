...
| 학습 시작이 오래 걸린다 | 이미지를 S3에서 받는 중입니다. 약 1.9 GB입니다. 한 번 다 받으면 묶음 하나로 올라가고 다음부터는 그것만 받으므로 훨씬 빠릅니다 |
...
이 dataset의 이미지 묶음을 아직 아무도 만들지 않았다면 첫 실행만 오래 걸립니다. 그 실행이 한 epoch을 돌면 묶음이 올라가고, 그다음부터는 팀 전체가 빠르게 시작합니다.
